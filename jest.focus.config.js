...
module.exports = {
    ...
    testMatch: [
        '**/tests/features/ai/server/projectors.test.ts',
        '**/tests/features/components/services/envVarHelpers.test.ts',
        '**/tests/features/components/services/serviceGroupTransforms.test.ts',
        '**/tests/core/ui/components/layout/TwoColumnLayout.test.tsx',
        '**/tests/core/ui/hooks/useSelection.test.ts',
    ],
};

...
module.exports = {
    ...
    // Environment: node
    testMatch: [
        '**/tests/features/mesh/services/stalenessDetector-changeDecisions.test.ts',
        '**/tests/features/mesh/services/stalenessDetector-edgeCases.test.ts',
        '**/tests/features/mesh/services/stalenessDetector-envFileReader.test.ts',
        ...
        '**/tests/features/mesh/services/stalenessDetector.test.ts',
    ],
};

...
module.exports = {
    ...
    testMatch: [
        ...
        '**/tests/features/prerequisites/services/PrerequisitesManager-decisions-check.test.ts',
        '**/tests/features/prerequisites/services/PrerequisitesManager-decisions-config.test.ts',
        '**/tests/features/prerequisites/services/PrerequisitesManager-decisions-perNode.test.ts',
        ...
        '**/tests/features/prerequisites/services/PrerequisitesManager-mockValidation.test.ts',

...
module.exports = {
    ...
    // Environment: node
    testMatch: [
        '**/tests/core/shell/ensureNodeVersion.test.ts',
        '**/tests/features/ai/server/validateSelectionTool.test.ts',
        '**/tests/features/components/services/componentManager-install-delegation.test.ts',

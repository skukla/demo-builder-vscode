...
module.exports = {
    ...
    // Environment: node
    testMatch: [
        '**/tests/features/prerequisites/services/prerequisitesCacheManager-boundaries.test.ts',
        '**/tests/features/prerequisites/services/prerequisitesCacheManager-collaborators.test.ts',

...
module.exports = {
    ...
    // Environment: node
    testMatch: [
        '**/tests/features/authentication/handlers/authenticationHandlers-authenticate-edge-cases.test.ts',
        '**/tests/features/authentication/handlers/authenticationHandlers-authenticate-errors.test.ts',
        '**/tests/features/authentication/handlers/authenticationHandlers-authenticate-new-auth.test.ts',

 ...
 */
/**
 * Do-not-edit banner. AGENTS.md is fully generated from project state (org,
 * workspace, block libraries, status…) and rewritten on create/reset and by
 * "Regenerate AI Files", so hand edits cannot survive by design — say so up front
 * rather than silently overwriting a user's notes. (settings.json, which users DO
 * legitimately customize, is merged instead — see mcpConfigWriter.)
 */
const GENERATED_NOTICE =
    '<!-- GENERATED by Adobe Demo Builder — do not edit by hand. This file is regenerated ' +
    'from project state on create/reset and by "Regenerate AI Files"; hand edits are overwritten. -->';

...
function buildHomeWorkingOnProjects(): string {
    return [
        ...
        'state which project you are working on (e.g. "Working on citisignal-b2b…") before',
        'taking any action. If it returns null, ask the user which project they mean rather',
        'than guessing. The other tools resolve the same active project automatically, but',
        'naming it up front confirms you and the user are on the same project.**',
        '',

/**
 * Mesh Check Helper Functions
 *
 * Extracted helper functions for mesh status checking operations.
 * Originally from checkHandler.ts, moved to services layer for proper separation.
 */

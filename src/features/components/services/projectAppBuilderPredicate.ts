 ...
 * connection, an API Mesh, and other components. Some of those involve
 ...
 * against the registry's `mesh` category. Returns false if `componentInstances`
 * isn't populated yet — callers using this before install should query the
 * registry directly from `componentSelections`.
 */

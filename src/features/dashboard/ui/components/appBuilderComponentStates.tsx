 ...
 * fills.
 *
 * @module features/dashboard/ui/components/appBuilderComponentStates
 */
...
/** AppBuilderComponent status as surfaced to the dashboard. */
export type AppBuilderComponentViewStatus = 'not-deployed' | 'deploying' | 'deployed' | 'error';

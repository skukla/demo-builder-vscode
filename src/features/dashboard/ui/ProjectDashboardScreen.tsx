 ...
 */
export function ProjectDashboardScreen({ project, hasMesh = false, brandName, stackName, isEds = false, isContentFlow = false, contentSourceType, edsLiveUrl, edsDaLiveUrl, authoringExperience, initialMeshStatus, initialEdsStorefrontStatus }: ProjectDashboardScreenProps) {

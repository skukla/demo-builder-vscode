...
export interface EDSConfig {
    ...
    /**
     * Existing repository full name (owner/repo format).
     * Migration fallback: read alongside selectedRepo to support projects
     * serialized before selectedRepo existed (see storefrontSetupPhase1).
     */
    existingRepo?: string;

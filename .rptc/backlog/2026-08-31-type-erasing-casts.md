...
- 2026-09-01  docs(development): the toolchain, with the trap each tool carries (`7caed6863`)
- 2026-09-01  test: 215 `as never` casts removed, and a text-based converter caught corrupting a control (`917e63be8`)
- 2026-09-01  test(sop): the five closed cast families were silently unenforced — a ban list closes it (`ead58767f`)
- 2026-09-01  docs(skills): ask-the-tool — let the compiler decide, instead of reading every site (`683412f56`)

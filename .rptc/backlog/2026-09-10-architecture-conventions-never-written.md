...
- 2026-09-11  feat(tooling): every rule in the shared architecture suite is proven — 67 of 68 (`16ee6d836`)
- 2026-09-11  feat(tooling): the CSS conventions are proven — 59 of 68 (`f3b08e6c7`)
- 2026-09-11  feat(tooling): a plant can be SEVERAL files, and seven more proofs — 52 of 68 (`8a3cb60a3`)
- 2026-09-11  feat(tooling): six more proofs, and the first convention that CANNOT be proven — 45 of 68 (`691e7d699`)
- 2026-09-11  feat(tooling): proofs can EDIT a file, and dist/ is borrowed — 36 of 68 (`87f8ce28b`)
- 2026-09-11  feat(tooling): both webview architecture rules proven — 34 of 68 (`6382b47a2`)
- 2026-09-11  feat(tooling): four proofs inside the shared architecture suite — 32 of 68 (`af3d36d92`)
- 2026-09-11  feat(tooling): proofs can APPEND, and three more are proven — 28 of 68 (`f6d243170`)
- 2026-09-11  feat(tooling): three more convention proofs — 25 of 68 (`6da6e121a`)
- 2026-09-11  feat(tooling): three more convention proofs — 22 of 68 (`8f526d844`)
...
- 2026-09-15  fix(updates): a failed template reset or update says which step failed, in plain words (`51b59e51b`)
- 2026-09-15  Merge fix/error-strategy: errors a person reads are translated, and the central error classes are gone (`66847c049`)
- 2026-09-11  docs(errors): record the owner's eight decisions where they can be found (`1670fd8ca`)
- 2026-09-11  feat(mcp): delete_adobe_workspace — the last real reversibility gap closes (`bd8dbfeb2`)
- 2026-09-11  docs(adr): ADR-023 ratifies the error strategy — the record that did not exist (`1356ca898`)
- 2026-09-11  refactor(errors)!: the central hierarchy is gone; the shape it carried is not (`092d72f3f`)
- 2026-09-11  refactor(errors): two domain errors move to the code that throws them (`9dd1f69fe`)

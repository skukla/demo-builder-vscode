...
- 2026-08-28  RATIFIED AND RECORDED: ADR-016 (test strategy) accepted 2026-08-28 — the slate became law: three tiers, Jest retained with cited criteria, eslint-plugin-jest, noise-to-zero with fail-on-console, Stryker effectiveness pilot, adjudicated-floor duplication target, family-testUtils rule, deps-object doubles. Indexed in docs/architecture/CLAUDE.md; routed from root CLAUDE.md beside ADR-015. The question this item asked is fully answered; execution tracked under PL-11.

...
- 2026-09-08  fix(tests): the UI tier read the wrong surface, and said the wrong reason why (`bbcb6371c`)
- 2026-09-08  docs(backlog): PL-46 — the owner's destination, and why extending stopped (`d7d277693`)
- 2026-09-08  perf(tests): the activation tier uses the VS Code already installed — 1.1 GB saved (`5a1f078aa`)
- 2026-09-08  fix(package): the UI tier would have shipped 329 MB, and 11 dev configs already were (`7cc8cddd7`)
- 2026-09-08  docs(backlog): PL-46 rung two — the UI tier drives a real editor (`af0ecad1a`)

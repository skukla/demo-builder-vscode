...
- 2026-09-10  2026-09-10  Done-gate RETIRED from the sweep. It proved completeness AT THE TIME OF THE AUDIT; 1,600 commits later it reported 66 rows naming files that shipped work deleted (mostly PL-31's barrels) — drift, not incompleteness. Declared a one-shot in NON_INSTRUMENT_SCRIPTS; still on disk and runnable by hand. The harness's other four instruments are unaffected, which is why the plan dir stays in plans/.

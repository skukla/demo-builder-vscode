...
- 2026-08-26  ANSWERED by the 2026-08-26 battery, against the reading this item proposed: discoverability is NOT the constraint. The agent searched and found the right tool on every prompt, including four never named in the bundle and never used in a real session, and found run_commerce_query on first exposure. The 85 unused tools are unneeded, not unfindable. What costs round trips instead: our own tools being subtly wrong, and not knowing HOW to use a capability once found (AI-1k).
- 2026-08-26  feat(skills): tool-verdicts — answer "is this tool worth having" from evidence (`0e9c53ac0`)
- 2026-08-26  docs(backlog): AI-1b answered — discoverability is not the constraint (`d9aef2e4e`)
- 2026-08-26  RE-CHECKED against the real surface: with all four MCP servers available (74 tools), the agent still chose ours on 10 of 10 prompts and reached for another server ZERO times. The earlier answer was measured in a world where our tools were the only option; it survives that being fixed. Caveat: our 10 prompts target OUR jobs — this says we win on our ground, not everywhere.

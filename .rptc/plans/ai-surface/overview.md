...
| 4 | 🟡 **Coverage breadth** — Groups 1, 2 and 4 shipped 2026-08-17 (65 → 77 tools), Wave 3 added `add_integration` on top; Groups 5–7 remain | Expose the qualifying unexposed handlers. Step 01's list was too short: it disqualified 21 handlers for pushing their result through `sendMessage`, which `capturePayloadFrom` now solves without touching a handler. | `phase-4-step-02-full-parity-plan.md` · handoff: `.rptc/handoff/2026-08-17-ai-surface-phase-4.md` |

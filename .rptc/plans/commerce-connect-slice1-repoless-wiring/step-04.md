...
- **Remaining (c):** (4) WelcomeStep gallery suppression (flow+upstream) — the render hides the brand gallery when seeded. **F5-gated** (live render). The cross-webview launch (3) is build-verified; the *visual* handoff is F5.

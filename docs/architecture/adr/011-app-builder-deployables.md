...
**Status**: Accepted — implemented (D1–D3; D3 merged to develop `5d6f4956`, 2026-07-16); plan at [`.rptc/backlog/appbuilder-deployable-model/`](../../../.rptc/backlog/appbuilder-deployable-model/overview.md)
**Date**: 2026-06-19

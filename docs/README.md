...
- **[Evaluation Mode](./systems/evaluation-mode.md)** - Try a prompt out with every change simulated: what it would do, what it would cost, and where it wasted steps. Also the dry run that makes agent mutation impossible.

...
|---|---|---|
| per-tool-call | 18 hook rules in `.claude/hooks/rules/` | automatic |
| per-jest-run | 47 enforcer suites in `tests/sop/` | automatic |
...
this codebase holds itself to — 102 of them, 102 with an enforcer that fails the build — and

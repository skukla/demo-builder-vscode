...
|---|---|---|
| per-tool-call | 12 hook rules in `.claude/hooks/rules/` | automatic |
| per-jest-run | 46 enforcer suites in `tests/sop/` | automatic |
...
this codebase holds itself to — 90 of them, 89 with an enforcer that fails the build — and

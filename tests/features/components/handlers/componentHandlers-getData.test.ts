/**
 * Tests for componentHandlers - handleGetComponentsData (Pattern B)
 *
 * Split from componentHandlers.test.ts to stay under the max-lines limit.
 * Shared mock factories are imported from componentHandlers.testUtils.ts; the

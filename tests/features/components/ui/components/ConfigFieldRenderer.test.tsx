...
describe('ConfigFieldRenderer', () => {
    ...
    describe('MESH_ENDPOINT special handling', () => {
        ...
        const meshEndpointFieldWithDescription: UniqueField = {
            ...meshEndpointField,
            description: 'Custom description',
        };

        it('renders as read-only field', () => {
            const { container } = renderWithProvider(
                <ConfigFieldRenderer
                    field={meshEndpointField}
                    value=""
                    error={undefined}
                    isTouched={false}
                    onUpdate={mockOnUpdate}
        ...
        it('shows default auto-fill description when empty and no custom description', () => {
            renderWithProvider(
                <ConfigFieldRenderer
                    field={meshEndpointField}
                    value=""
            ...
            expect(screen.getByText('This will be set automatically after Mesh deployment.')).toBeInTheDocument();
        });

        it('shows custom description when empty and description provided', () => {
            renderWithProvider(
                <ConfigFieldRenderer
                    field={meshEndpointFieldWithDescription}
                    value=""
                    error={undefined}
                    isTouched={false}
                    onUpdate={mockOnUpdate}
        ...
        it('shows auto-filled description when has value', () => {
            renderWithProvider(
                <ConfigFieldRenderer
                    field={meshEndpointField}
                    value="https://mesh.example.com/graphql"
                    error={undefined}
                    isTouched={false}
                    onUpdate={mockOnUpdate}
                />
        ...
        it('renders field wrapper with correct id', () => {
            ...
            expect(container.querySelector('#field-MESH_ENDPOINT')).toBeInTheDocument();
        });
    });

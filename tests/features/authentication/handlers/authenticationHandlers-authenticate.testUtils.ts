/**
 * Shared Test Utilities for handleAuthenticate Test Suite
 *
 * Common mock factories and test data used across authenticate handler tests.
 * Extracted from authenticationHandlers-authenticate.test.ts to support split test files.
 */
...
// Test data - mock organizations and projects
...
/**
 * Creates a mock HandlerContext for testing handleAuthenticate
 *

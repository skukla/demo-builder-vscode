/**
 * Deployable Config Fields Tests (D2 Track B — Step 04)
 *
 * The Configure surface renders ANY deployable's user-provided inputs (bucket 3)
...
import { DeployableFieldsSection } from '@/features/dashboard/ui/configure/DeployableFieldsSection';
...
const consumerEntry: DeployableCatalogEntry = {
...
const seedMeshEntry: DeployableCatalogEntry = {
...
function renderSection(props: Partial<React.ComponentProps<typeof DeployableFieldsSection>> = {}) {
...
describe('DeployableFieldsSection', () => {
    it('renders a section labeled by the deployable name', () => {
    ...
    it('renders no new editable fields for a seed mesh (mesh = zero input)', () => {
        ...
        // No section, no inputs at all for a deployable whose only var is derived.

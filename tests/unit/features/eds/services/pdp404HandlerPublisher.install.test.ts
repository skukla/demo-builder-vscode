 ...
 *
 * Covers the orchestrator (installSmart404Handler) end-to-end. The two
 * pure helpers (buildSmart404Snippet, derivePrepublishUrl) and
 * extractCspNonce are covered in the sibling
 * pdp404HandlerPublisher.test.ts.
 *

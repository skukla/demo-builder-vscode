    ...
    describe('validateAccessToken', () => {
        ...
        describe('command injection attacks', () => {
            it('should reject tokens with semicolons', () => {
                ...
                expect(() => validateAccessToken(malicious)).toThrow(/illegal characters/);
            });
            ...
            it('should reject tokens with shell metacharacters', () => {
                ...
                expect(() => validateAccessToken(token1)).toThrow(/illegal characters/);
                expect(() => validateAccessToken(token2)).toThrow(/illegal characters/);
                expect(() => validateAccessToken(token3)).toThrow(/illegal characters/);
            });
            ...
            it('should reject tokens with spaces', () => {
                ...
                expect(() => validateAccessToken(tokenWithSpace)).toThrow(/illegal characters/);
            });

            it('should reject tokens with backslashes', () => {
                // Token must be 50+ chars to pass length check
                const tokenWithBackslash = 'eyJ' + 'a'.repeat(47) + '\\test';
                expect(() => validateAccessToken(tokenWithBackslash)).toThrow(/illegal characters/);
            });
        });
        ...
        describe('format validation', () => {
            it('should reject tokens not starting with eyJ', () => {
                ...
                expect(() => validateAccessToken(invalid)).toThrow(/must be a valid JWT token/);
            });

            it('should reject tokens too short', () => {
                const short = 'eyJhbGci';
                expect(() => validateAccessToken(short)).toThrow(
                    /length must be between 50 and 5000/
                );
            });

            it('should reject tokens too long', () => {
                const long = 'eyJ' + 'a'.repeat(4999); // Total 5002 chars
                expect(() => validateAccessToken(long)).toThrow(
                    /length must be between 50 and 5000/
                );
            });
        });
        ...
        describe('edge cases', () => {
            it('should reject empty strings', () => {
                expect(() => validateAccessToken('')).toThrow(/must be a non-empty string/);
            });

            it('should reject null/undefined', () => {
                expect(() => validateAccessToken(null as unknown as string)).toThrow(
                    /must be a non-empty string/
                );
                expect(() => validateAccessToken(undefined as unknown as string)).toThrow(
                    /must be a non-empty string/
                );
            });

            it('should reject non-string values', () => {
                expect(() => validateAccessToken(123 as unknown as string)).toThrow(
                    /must be a non-empty string/
                );
            });
        });
    ...
    describe('validateURL', () => {
        ...
        describe('protocol validation', () => {
            ...
            it('should reject dangerous protocols', () => {
                expect(() => validateURL('javascript:alert(1)')).toThrow(/protocol must be one of/);
                expect(() => validateURL('file:///etc/passwd')).toThrow(/protocol must be one of/);
                expect(() => validateURL('ftp://example.com')).toThrow(/protocol must be one of/);
        ...
        describe('SSRF protection - localhost', () => {
            it('should reject localhost hostname', () => {
                expect(() => validateURL('https://localhost')).toThrow(/localhost are not allowed/);
            ...
            it('should reject 127.0.0.1', () => {
                expect(() => validateURL('https://127.0.0.1')).toThrow(/localhost are not allowed/);
                expect(() => validateURL('https://127.0.0.1:8080')).toThrow(
                    /localhost are not allowed/
                );
            });
            ...
            it('should reject IPv6 localhost', () => {
                ...
                expect(() => validateURL('https://[::1]')).toThrow(/localhost/);
            });

            it('should reject loopback IPs', () => {
                expect(() => validateURL('https://127.0.0.2')).toThrow(
                    /local\/private networks are not allowed/
                );
                expect(() => validateURL('https://127.255.255.255')).toThrow(
                    /local\/private networks are not allowed/
                );
            });
        });
        ...
        describe('SSRF protection - private networks', () => {
            it('should reject 10.0.0.0/8 private range', () => {
                ...
                expect(() => validateURL('https://10.255.255.255')).toThrow(
                    /local\/private networks are not allowed/
                );
            });

            it('should reject 192.168.0.0/16 private range', () => {
                expect(() => validateURL('https://192.168.0.1')).toThrow(
                    /local\/private networks are not allowed/
                );
                expect(() => validateURL('https://192.168.255.255')).toThrow(
                    /local\/private networks are not allowed/
                );
            });
            ...
            it('should reject 172.16.0.0/12 private range', () => {
                ...
                expect(() => validateURL('https://172.31.255.255')).toThrow(
                    /local\/private networks are not allowed/
                );
            });
        ...
        describe('SSRF protection - cloud metadata', () => {
            ...
            it('should reject IPv6 metadata endpoint', () => {
                ...
                expect(() => validateURL('https://[fd00:ec2::254]')).toThrow(
                    /(private IPv6|cloud metadata endpoints)/
                );
            });
        });
        ...
        describe('SSRF protection - IPv6', () => {
            it('should reject private IPv6 ranges', () => {
                ...
                expect(() => validateURL('https://[fc00::1]')).toThrow(/private IPv6/);
                expect(() => validateURL('https://[fd00::1]')).toThrow(/private IPv6/);
                // fe80::/10 requires special bracket handling in URL
                expect(() => validateURL('https://[fe80::1]')).toThrow(/private IPv6/);
            });
        });

        describe('edge cases', () => {
            it('should reject empty strings', () => {
                expect(() => validateURL('')).toThrow(/must be a non-empty string/);
            });

            it('should reject null/undefined', () => {
                expect(() => validateURL(null as unknown as string)).toThrow(/must be a non-empty string/);
                expect(() => validateURL(undefined as unknown as string)).toThrow(/must be a non-empty string/);
            });

            it('should reject malformed URLs', () => {
                expect(() => validateURL('not-a-url')).toThrow(/Invalid URL/);
                expect(() => validateURL('ht!tp://example.com')).toThrow(/Invalid URL/);
            });
        ...
        describe('XSS protection', () => {
            it('should reject javascript: URLs', () => {
                expect(() => validateURL('javascript:void(0)')).toThrow(/protocol must be one of/);
    ...
    describe('sanitizeErrorForLogging', () => {
        ...
        describe('token sanitization', () => {
            it('should sanitize JWT tokens', () => {
                const error = new Error(
                    'Auth failed with token eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIn0.signature123'
                );
                const sanitized = sanitizeErrorForLogging(error);
        ...
        describe('string input', () => {
            it('should handle string errors', () => {
                const sanitized = sanitizeErrorForLogging(
                    'Failed at /home/user/file with token abc123def456ghi789jkl012'
                );
                expect(sanitized).toContain('<path>/');
                expect(sanitized).toContain('<redacted>');
                expect(sanitized).not.toContain('/home/user/');
        ...
        describe('edge cases', () => {
            ...
            it('should handle complex mixed content', () => {
                const error = new Error(
                    'Auth failed at /home/user/.config with token eyJhbGci123456789012 and API_KEY=secret'
                );
                const sanitized = sanitizeErrorForLogging(error);
                expect(sanitized).not.toContain('/home/user/');

...
describe('CommandManager', () => {
    ...
    describe('Command Registration', () => {
        ...
        it('should register all 22 commands (23 total, but resetAll only in dev mode)', () => {
            commandManager.registerCommands();

            // Verify registerCommand was called 22 times (resetAll excluded - dev mode only)
            expect(vscode.commands.registerCommand).toHaveBeenCalledTimes(22);

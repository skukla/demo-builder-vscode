...
describe('useDebouncedLoading', () => {
    ...
    describe('initial state', () => {
        ...
        it('returns false initially even if isLoading is true', () => {
            ...
            // The 300ms debounce is still pending, and this test asserts the state
            // BEFORE it fires — deliberately, that is the whole claim. Flush it here,
            // inside act(): the react setup's afterEach runs runOnlyPendingTimers(),
            // which would otherwise fire this timer with no act scope on the stack.
            act(() => {

...
describe('useVSCodeMessage', () => {
    ...
    describe('basic functionality', () => {
        it('subscribes to messages on mount', () => {
            ...
            expect(webviewClient.onMessage).toHaveBeenCalledWith(
                'test-message',
                expect.any(Function)
            );
    ...
    describe('subscription lifecycle', () => {
        it('unsubscribes on unmount', () => {
            ...
            const { unmount } = renderHook(() => useVSCodeMessage('test-message', callback));
        ...
        it('resubscribes when message type changes', () => {
            ...
            const { rerender } = renderHook(({ type }) => useVSCodeMessage(type, callback), {

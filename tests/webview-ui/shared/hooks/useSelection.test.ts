...
describe('useSelection', () => {
    ...
    describe('select', () => {
        ...
        it('calls onChange callback when selecting', () => {
            ...
            const { result } = renderHook(() => useSelection<TestItem>({ onChange }));
    ...
    describe('clearSelection', () => {
        it('clears selected item', () => {
            const item = { id: '1', name: 'Item 1' };
            const { result } = renderHook(() => useSelection<TestItem>({ initialSelection: item }));
    ...
    describe('toggle', () => {
        ...
        it('switches between items', () => {
            const item1 = { id: '1', name: 'Item 1' };
            const item2 = { id: '2', name: 'Item 2' };
            const { result } = renderHook(() => useSelection<TestItem>({ getKey: (i) => i.id }));
    ...
    describe('function stability', () => {
        it('select function is stable when onChange is stable', () => {
            const onChange = jest.fn();
            const { result, rerender } = renderHook(() => useSelection<TestItem>({ onChange }));

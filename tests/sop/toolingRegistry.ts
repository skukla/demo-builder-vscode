...
const PERIODIC: readonly Instrument[] = [
    ...
    },
    {
        ...
        cadence: 'periodic',
        resultKind: 'gate',
        what: "the CSS migration's actions and its own checks — `--worklist` triages what is left and re-measures every deferred item, `--move` takes a family out of the god file in source order, `--verify` proves a moved family is byte-identical to the version before the move, and `--check` refuses a count that moved inconsistently",
        runs: 'npm run css:cycle -- --worklist',
        writes: true,
    },
    {
        id: 'css:harness',

...
function renderJest(modulePath, suites) {
    ...
    // all but six modules. `enableFindRelatedTests` and Stryker's per-test coverage both
...
module.exports = {
    ...
    // Environment: ${which === 'react' ? 'jsdom — every suite for this module is a React suite' : 'node'}
    testMatch: [
